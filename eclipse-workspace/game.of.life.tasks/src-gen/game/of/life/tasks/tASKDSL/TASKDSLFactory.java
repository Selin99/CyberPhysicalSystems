...
public interface TASKDSLFactory extends EFactory
{
   ...
   * @generated
   */
  TASKDSLFactory eINSTANCE = game.of.life.tasks.tASKDSL.impl.TASKDSLFactoryImpl.init();
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Start Grid</em>'.
   * @generated
   */
  StartGrid createStartGrid();

  /**
   * Returns a new object of class '<em>av Action</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>av Action</em>'.
   * @generated
   */
  avAction createavAction();
