...
public class TASKDSLAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected TASKDSLSwitch<Adapter> modelSwitch =
    new TASKDSLSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseavAction(avAction object)
      {
        return createavActionAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link game.of.life.tasks.tASKDSL.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link game.of.life.tasks.tASKDSL.Game <em>Game</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link game.of.life.tasks.tASKDSL.GridSize <em>Grid Size</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createStartGridAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link game.of.life.tasks.tASKDSL.avAction <em>av Action</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createavActionAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link game.of.life.tasks.tASKDSL.Cell <em>Cell</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
