...
class GameOfLife {
	def static gameOfLife(Game root)'''
		package GameOfLife;
		...
		public class GameOfLife extends JFrame implements ActionListener {
		    ...
		    public void actionPerformed(ActionEvent ae) {
		        if (ae.getSource().equals(mi_file_exit)) {
		           ...
		           gb_gameBoard.randomlyFillBoard(0);
		    ...
		    private class GameBoard extends JPanel implements ComponentListener, MouseListener, MouseMotionListener, Runnable {
		        private Dimension d_gameBoardSize = new Dimension(75, 50);
		        ...
		        public void randomlyFillBoard(int percent) {    		        	
		            «FOR cells: root.allCells»
		            	«updateGrid(cells.s)»(«cells.XC»,«cells.YC»);	 			        			                	
		            «ENDFOR»
		        }
	...
	'''
	def static updateGrid(Status s)'''
		«IF s == Status::LIVE»
			addPoint
		«ELSE»
			removePoint
